...
export default function FecharHorarios() {
  ...
  return (
    <Admin title="opcoes">
      <div className="main_container">
        <HeaderPage title="Fechar horários" />
        <h3 className=''>Selecione o dia e os horários que devem ser fechados.</h3>
        <form onSubmit={handleSubmit(handleCloseRoom)} className="pb-24">
          ...
          <div className='mt-3'>
            <button className='btn btn-warning' disabled={isSubmitting}>Fechar horários</button>
          </div>
        </form>
      </div>
    </Admin>
